    ...
    <div className="mb-1">
        <div className={styles["score-info"] + " mb-1"}>
            <div className={styles["score-info__first-sec"]}>
                ...
                {max_score == 10 ? <span> You scored <span className={styles["score-info__actual"]}>0{score}</span>/<span className={styles["score-info__base"]}>{max_score}</span></span> : <span> You scored <span className={styles["score-info__actual"]}>{Math.round((score/max_score)*100)}%</span></span>}
            </div>
