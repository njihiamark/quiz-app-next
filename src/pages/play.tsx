        ...
        <Layout theme="light">
            <div className="w-33-auto">
                ...
                {data.length > 0 && !pending ? <div>
                    <Button label="true" type="filled" theme="light" onClick={() => handleAnswering("True")} refValue={trueBtnRef} />
                    <div className="mb-2"></div>
                    <Button label="false" type="outline" theme="light" onClick={() => handleAnswering("False")} refValue={falseBtnRef} />
